...
Gabriel avalia o modelo com MSE e R² no conjunto de teste — e apresenta o erro em escala original usando `np.exp(np.sqrt(MSE))`, o que dá uma interpretação direta: *"em média, o modelo erra X% do valor real do imóvel"*.
